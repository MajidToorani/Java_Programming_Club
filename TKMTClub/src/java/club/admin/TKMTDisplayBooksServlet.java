 ...
 * @author taran
 */
@WebServlet(name = "TKMTDisplayBooksServlet", urlPatterns = {"/TKMTDisplayBooks"})
public class TKMTDisplayBooksServlet extends HttpServlet {
    ...
    //save oject to the request
     request.setAttribute("books", books);
     
     String url = "/TKMTDisplayBooks.jsp";
        getServletContext()
