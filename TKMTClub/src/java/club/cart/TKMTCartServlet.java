 ...
 * @author majid
 */
public class TKMTCartServlet extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet TKMTCartServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet TKMTCartServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
        ...
        getServletContext()
                .getRequestDispatcher("/TKMTECart.jsp")
